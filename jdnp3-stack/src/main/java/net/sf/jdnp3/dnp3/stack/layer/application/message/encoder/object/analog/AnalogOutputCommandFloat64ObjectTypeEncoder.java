...
public class AnalogOutputCommandFloat64ObjectTypeEncoder implements ObjectTypeEncoder {
	public boolean canEncode(FunctionCode functionCode, ObjectType objectType) {
		return objectType.equals(ANALOG_OUTPUT_COMMAND_FLOAT64);
	}
	...
	public void encode(ObjectFragmentEncoderContext context, ObjectInstance objectInstance, Deque<Byte> data) {
		...
		AnalogOutputCommandObjectInstance specificInstance = (AnalogOutputCommandObjectInstance) objectInstance;
		DataUtils.addDouble(specificInstance.getValue(), data);
		addInteger((long) specificInstance.getStatusCode().getCode(), 1, data);
	}
}
