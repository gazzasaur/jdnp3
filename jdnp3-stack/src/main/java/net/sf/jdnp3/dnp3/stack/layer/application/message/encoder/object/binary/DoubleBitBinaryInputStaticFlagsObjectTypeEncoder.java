...
public class DoubleBitBinaryInputStaticFlagsObjectTypeEncoder implements ObjectTypeEncoder {
	public boolean canEncode(FunctionCode functionCode, ObjectType objectType) {
		return FunctionCodeUtils.isResponseCode(functionCode) && objectType.equals(DOUBLE_BIT_BINARY_INPUT_STATIC_FLAGS);
	}
