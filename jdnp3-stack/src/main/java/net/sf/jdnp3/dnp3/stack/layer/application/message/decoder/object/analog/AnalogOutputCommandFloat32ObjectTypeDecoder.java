...
public class AnalogOutputCommandFloat32ObjectTypeDecoder implements ObjectTypeDecoder {
	public boolean canDecode(ApplicationFragmentDecoderContext decoderContext) {
		return decoderContext.getObjectType().equals(ANALOG_OUTPUT_COMMAND_FLOAT32);
	}
