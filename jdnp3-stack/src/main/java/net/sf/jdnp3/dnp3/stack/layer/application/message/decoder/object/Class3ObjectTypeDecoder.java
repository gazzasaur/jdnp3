...
import net.sf.jdnp3.dnp3.stack.layer.application.model.object.Class3ObjectInstance;
...
public class Class3ObjectTypeDecoder implements ObjectTypeDecoder {
	public boolean canDecode(FunctionCode functionCode, ObjectFragment objectFragment) {
		return (functionCode.equals(READ) || functionCode.equals(ENABLE_UNSOLICITED) || functionCode.equals(DISABLE_UNSOLICITED))
				&& objectFragment.getObjectFragmentHeader().getObjectType().equals(ObjectTypeConstants.CLASS_3)
	...
	public void decode(FunctionCode functionCode, ObjectFragment objectFragment, List<Byte> data) {
		...
		objectFragment.addObjectInstance(new Class3ObjectInstance());
	}
}
