...
public class BinaryInputStaticTypeRationaliserHelper implements ObjectInstanceTypeRationaliserHelper {
	...
	private List<ObjectType> validObjectTypes = Arrays.asList(ANY, BINARY_INPUT_STATIC_ANY, BINARY_INPUT_STATIC_FLAGS, BINARY_INPUT_STATIC_PACKED);
	...
	public void rationalise(ObjectInstance objectInstance) {
		...
		if (!specificInstance.isOnline()
				...
				|| specificInstance.equals(BINARY_INPUT_STATIC_FLAGS)) {
