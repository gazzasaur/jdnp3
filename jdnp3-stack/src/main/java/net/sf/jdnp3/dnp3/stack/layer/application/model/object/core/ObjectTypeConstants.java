...
public class ObjectTypeConstants {
	...
	public static int DOUBLE_BIT_BINARY_INPUT_STATIC_GROUP = 3;
	public static ObjectType DOUBLE_BIT_BINARY_INPUT_STATIC_ANY = new ObjectType(DOUBLE_BIT_BINARY_INPUT_STATIC_GROUP, 0);
	...
	public static int ANALOG_INPUT_STATIC_GROUP = 30;
	public static ObjectType ANALOG_INPUT_STATIC_ANY = new ObjectType(ANALOG_INPUT_STATIC_GROUP, 0);
	public static ObjectType ANALOG_INPUT_STATIC_INT32 = new ObjectType(ANALOG_INPUT_STATIC_GROUP, 1);
	public static ObjectType ANALOG_INPUT_STATIC_INT16 = new ObjectType(ANALOG_INPUT_STATIC_GROUP, 2);
	public static ObjectType ANALOG_INPUT_STATIC_INT32_NO_FLAGS = new ObjectType(ANALOG_INPUT_STATIC_GROUP, 3);
	public static ObjectType ANALOG_INPUT_STATIC_INT16_NO_FLAGS = new ObjectType(ANALOG_INPUT_STATIC_GROUP, 4);
	public static ObjectType ANALOG_INPUT_STATIC_FLOAT32 = new ObjectType(ANALOG_INPUT_STATIC_GROUP, 5);
	public static ObjectType ANALOG_INPUT_STATIC_FLOAT64 = new ObjectType(ANALOG_INPUT_STATIC_GROUP, 6);

	public static int ANALOG_INPUT_EVENT_GROUP = 32;
