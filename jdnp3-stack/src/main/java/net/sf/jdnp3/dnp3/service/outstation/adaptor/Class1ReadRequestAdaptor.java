...
import net.sf.jdnp3.dnp3.service.outstation.handler.generic.Class1ReadRequestHandler;
...
public class Class1ReadRequestAdaptor implements OutstationRequestHandlerAdaptor {
	private static final Logger LOGGER = LoggerFactory.getLogger(Class1ReadRequestAdaptor.class);
