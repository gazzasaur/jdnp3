...
import static net.sf.jdnp3.dnp3.stack.layer.application.model.object.core.ObjectTypeConstants.COUNTER_EVENT_INT16_FLAGS_DELTA_TIME;
...
public class CounterEventInteger16AbsoluteTimeDeltaObjectTypeEncoder implements ObjectTypeEncoder {
	public boolean canEncode(FunctionCode functionCode, ObjectType objectType) {
		return objectType.equals(COUNTER_EVENT_INT16_FLAGS_DELTA_TIME);
	}
	...
	public void encode(ObjectFragmentEncoderContext context, ObjectInstance objectInstance, List<Byte> data) {
		...
		CounterEventObjectInstance specificInstance = (CounterEventObjectInstance) objectInstance;
		data.add(CounterFlagsEncoder.encode(specificInstance));
		addInteger((long) specificInstance.getValue(), 2, data);
		addInteger((long) specificInstance.getTimestamp(), 6, data);
	}
}
