...
import static net.sf.jdnp3.dnp3.stack.layer.application.model.object.core.ObjectTypeConstants.COUNTER_EVENT_INT32_FLAGS_DELTA_TIME;
...
public class CounterEventInteger32AbsoluteTimeDeltaObjectTypeEncoder implements ObjectTypeEncoder {
	public boolean canEncode(FunctionCode functionCode, ObjectType objectType) {
		return objectType.equals(COUNTER_EVENT_INT32_FLAGS_DELTA_TIME);
	}
