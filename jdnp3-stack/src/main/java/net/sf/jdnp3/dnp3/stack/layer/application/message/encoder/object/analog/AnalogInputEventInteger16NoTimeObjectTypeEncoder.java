...
import static net.sf.jdnp3.dnp3.stack.layer.application.model.object.ObjectTypeConstants.ANALOG_INPUT_EVENT_INT16_WITHOUT_TIME;
...
public class AnalogInputEventInteger16NoTimeObjectTypeEncoder implements ObjectTypeEncoder {
	public boolean canEncode(FunctionCode functionCode, ObjectType objectType) {
		return functionCode.equals(FunctionCode.RESPONSE) && objectType.equals(ANALOG_INPUT_EVENT_INT16_WITHOUT_TIME);
	}
