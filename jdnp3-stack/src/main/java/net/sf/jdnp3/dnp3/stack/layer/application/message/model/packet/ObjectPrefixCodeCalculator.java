...
import static net.sf.jdnp3.dnp3.stack.layer.application.message.model.packet.ObjectPrefixCode.FOUR_OCTET_INDEX;
import static net.sf.jdnp3.dnp3.stack.layer.application.message.model.packet.ObjectPrefixCode.FOUR_OCTET_LENGTH;
import static net.sf.jdnp3.dnp3.stack.layer.application.message.model.packet.ObjectPrefixCode.ONE_OCTET_INDEX;
import static net.sf.jdnp3.dnp3.stack.layer.application.message.model.packet.ObjectPrefixCode.ONE_OCTET_LENGTH;
import static net.sf.jdnp3.dnp3.stack.layer.application.message.model.packet.ObjectPrefixCode.TWO_OCTET_INDEX;
import static net.sf.jdnp3.dnp3.stack.layer.application.message.model.packet.ObjectPrefixCode.TWO_OCTET_LENGTH;
