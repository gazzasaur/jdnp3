...
import static net.sf.jdnp3.dnp3.stack.layer.application.model.object.core.ObjectTypeConstants.COUNTER_EVENT_INT16_FLAGS;
...
public class CounterEventInteger16ObjectTypeEncoder implements ObjectTypeEncoder {
	public boolean canEncode(FunctionCode functionCode, ObjectType objectType) {
		return objectType.equals(COUNTER_EVENT_INT16_FLAGS);
	}
