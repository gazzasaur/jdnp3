...
public class DoubleBitBinaryInputEventAbsoluteTimeObjectTypeEncoder implements ObjectTypeEncoder {
	public boolean canEncode(FunctionCode functionCode, ObjectType objectType) {
		return FunctionCodeUtils.isResponseCode(functionCode) && objectType.equals(DOUBLE_BIT_BINARY_INPUT_EVENT_ABSOLUTE_TIME);
	}
