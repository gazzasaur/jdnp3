...
jdnp3.doublebitbinaryinput.createDialog = function(index) {
	...
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('di-' + index + '-ev-0', 'Any', 0, function() {var value = {'group': 4, 'variation': 0}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.doublebitbinaryinput.doubleBitBinaryinputPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('di-' + index + '-ev-1', 'Without Time', 1, function() {var value = {'group': 4, 'variation': 1}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.doublebitbinaryinput.doubleBitBinaryinputPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('di-' + index + '-ev-2', 'Absolute Time', 2, function() {var value = {'group': 4, 'variation': 2}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.doublebitbinaryinput.doubleBitBinaryinputPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('di-' + index + '-ev-3', 'Relative Time', 3, function() {var value = {'group': 4, 'variation': 3}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.doublebitbinaryinput.doubleBitBinaryinputPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));

	staticElementRow.appendChild(staticElementItems);
	table.appendChild(staticElementRow)

	var tags = jdnp3.doublebitbinaryinput.doubleBitBinaryinputPoints.get(index)['tags'];
