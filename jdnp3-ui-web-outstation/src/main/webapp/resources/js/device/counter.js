...
jdnp3.counter.createDialog = function(index) {
	...
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('ci-' + index + '-ev-4', '16-bit Integer Delta Without Time', 4, function() {var value = {'group': 22, 'variation': 3}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.counter.counterPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('ci-' + index + '-ev-5', '32-bit Integer Absolute Time', 5, function() {var value = {'group': 22, 'variation': 3}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.counter.counterPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('ci-' + index + '-ev-6', '16-bit Integer Absolute Time', 6, function() {var value = {'group': 22, 'variation': 3}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.counter.counterPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('ci-' + index + '-ev-7', '32-bit Integer Delta Absolute Time', 7, function() {var value = {'group': 22, 'variation': 3}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.counter.counterPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
	staticElementItems.appendChild(jdnp3.ui.createCheckbox('ci-' + index + '-ev-8', '16-bit Integer Delta Absolute Time', 8, function() {var value = {'group': 22, 'variation': 3}; var attribute = 'eventType'; device.requestChangeAttributeValue(jdnp3.counter.counterPoints.get(index), attribute, value);}, {'style': 'margin-left: 5px;'}));
