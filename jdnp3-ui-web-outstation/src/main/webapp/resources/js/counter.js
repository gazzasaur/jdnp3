...
jdnp3.counter.createDialog = function(index) {
	...
	staticElementItems.appendChild(jdnp3.ui.createSlideSwitch('ci-' + index + '-triggerEventOnChange', 'Trigger Event On Change', 'triggerEventOnChange', function() {var attribute = 'triggerEventOnChange'; var dataPoint = jdnp3.counter.counterPoints.get(index); device.requestChangeAttributeValue(dataPoint, attribute, !dataPoint[attribute]);}));
...
jdnp3.counter.createRefreshCallback = function(index) {
	return function() {
		...
		var fieldId = 'ci-' + index + '-triggerEventOnChange';
