...
public class DoubleBitBinaryInputEventListener implements EventListener {
	...
	public DoubleBitBinaryInputEventListener(Outstation outstation) {
	...
	public void eventReceived(DataPoint dataPoint, long timestamp) {
		if (dataPoint instanceof DoubleBitBinaryInputDataPoint) {
			DoubleBitBinaryInputEventObjectInstance binaryInputEventObjectInstance = new DoubleBitBinaryInputEventObjectInstance();
			try {
				DoubleBitBinaryInputDataPoint binaryDataPoint = (DoubleBitBinaryInputDataPoint) dataPoint;
