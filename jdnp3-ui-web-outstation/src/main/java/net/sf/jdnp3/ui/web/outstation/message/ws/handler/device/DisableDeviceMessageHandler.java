...
import net.sf.jdnp3.ui.web.outstation.message.ws.model.device.DisableDeviceMessage;

public class DisableDeviceMessageHandler implements DeviceMessageHandler {
	public boolean canHandle(Message message) {
		return message instanceof DisableDeviceMessage;
	}
	...
	public void processMessage(Messanger messanger, OutstationDevice outstationDevice, Message message) {
		...
		outstationDevice.getOutstation().disable();
	}
}
