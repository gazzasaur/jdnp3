...
public class BinaryInputEventMessageHandler implements DeviceMessageHandler {
	...
	public void processMessage(Messanger messanger, OutstationDevice outstationDevice, Message message) {
		...
		outstationDevice.getDatabaseManager().triggerBinaryInputEvent(binaryInputEventMessage.getIndex(), binaryInputEventMessage.getTimestamp());
	}
}
