...
import net.sf.jdnp3.ui.web.outstation.message.ws.model.device.UnbindDeviceMessage;
import net.sf.jdnp3.ui.web.outstation.message.ws.model.device.UnbindType;

public class UnbindDeviceMessageHandler implements MessageHandler {
	public boolean canHandle(Message message) {
		return message instanceof UnbindDeviceMessage;
	}
