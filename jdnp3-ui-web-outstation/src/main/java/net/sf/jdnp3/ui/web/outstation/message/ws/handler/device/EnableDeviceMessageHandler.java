...
import net.sf.jdnp3.ui.web.outstation.message.ws.model.device.EnableDeviceMessage;

public class EnableDeviceMessageHandler implements DeviceMessageHandler {
	public boolean canHandle(Message message) {
		return message instanceof EnableDeviceMessage;
	}
	...
	public void processMessage(Messanger messanger, OutstationDevice outstationDevice, Message message) {
		...
		outstationDevice.getOutstation().enable();
	}
}
