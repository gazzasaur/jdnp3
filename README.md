...
Linux:
```
java -cp ".:jdnp3-ui-web-outstation-0.12.5.jar" net.sf.jdnp3.ui.web.outstation.main.App
```
...
For example
jdnp3/jdnp3-ui-web-outstation/target/jdnp3-ui-web-outstation-0.12.5-bin.tar.gz
```
